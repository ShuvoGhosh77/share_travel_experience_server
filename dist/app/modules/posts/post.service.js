...
const insertIntoDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.posts.create({
        data: dataToCreate,
    });
    return result;
});
const getAllFromDB = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.posts.findMany({
    ...
    const total = yield prisma_1.default.posts.count();
    return {
        meta: {
            total,
            page,
...
const getByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.posts.findUnique({
        where: {
            id,
        },
    });
...
const updateOneInDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.posts.update({
        where: {
            id,
        },
        data: payload,
...
const deleteByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Now delete the post
    const result = yield prisma_1.default.posts.delete({
        where: {
            id,
        },
    });
